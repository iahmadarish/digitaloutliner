...
const ServicesPage = () => {
  ...
  return (
    <main>
      <Helmet>
        {/* 🔹 Title */}
        <title>Services | CONQUERIC - Web, Mobile App & Custom Software Development</title>

        {/* 🔹 Meta Description */}
        <meta
          name="description"
          content="Explore CONQUERIC's professional services including web development, mobile app development, ecommerce solutions, and custom software tailored to accelerate your business growth."
        />

        {/* 🔹 Meta Keywords */}
        <meta
          name="keywords"
          content="CONQUERIC services, web development, mobile app development, ecommerce solutions, custom software development, IT consulting, UI/UX design, digital transformation, enterprise solutions"
        />
        ...
        {/* 🔹 Open Graph / Facebook */}
        <meta property="og:title" content="Services | CONQUERIC - Web, App & Software Experts" />
        <meta
          property="og:description"
          content="Discover CONQUERIC's full range of services: website development, mobile apps, ecommerce, and scalable custom software solutions for your business."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.conqueric.com/services" />
        <meta property="og:image" content="https://conqueric.com/hero/hero.png" />

        {/* 🔹 Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Services | CONQUERIC - Web, App & Software Experts" />
        <meta
          name="twitter:description"
          content="Web development, mobile apps, ecommerce solutions & custom software — discover CONQUERIC’s professional services for business growth."
        />
        ...
        <script type="application/ld+json">
          {`
          {
            ...
            "description": "CONQUERIC provides web development, mobile app development, ecommerce platforms, and custom software services tailored to business needs.",
            "hasOfferCatalog": {
              "@type": "OfferCatalog",
              ...
              "itemListElement": [
                {
                  ...
                  "itemOffered": {
                    ...
                    "description": "Custom websites, React, Next.js, and enterprise-ready web apps."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    ...
                    "description": "Native & cross-platform apps with seamless user experience."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    ...
                    "description": "Scalable ecommerce platforms with secure payment integration."
                  }
                },
                {
                  "@type": "Offer",
                  "itemOffered": {
                    ...
                    "description": "Tailor-made software solutions to optimize business operations."
                  }
                }
              ]
            }
      ...
      <div className="bg-[#06140b] font-nunito text-white overflow-hidden">
        ...
        {/* ভিডিও ব্যাকগ্রাউন্ড সেকশন */}
        <div className="fixed  w-full py-40  overflow-hidden -z-60">
          <video 
            autoPlay 
            loop 
            muted 
        ...
        <motion.section
          ...
          className="pt-44 sm:pb-10 relative z-10"
        >
        ...
        <motion.section
          ...
          className="sm:py-20 relative z-10"
        >
        ...
        <motion.section
          ...
          variants={containerVariants}
          viewport={{ once: true }}
          className="py-20 bg-[#06140b] relative z-10"
        >
            ...
            >
              ...
              >
                ...
                {submitStatus.message && (
                  <div className={`mb-6 p-4 rounded-xl ${submitStatus.success ? 'bg-green-900/30 text-green-300 border border-green-700' : 'bg-red-900/30 text-red-300 border border-red-700'}`}>
                    {submitStatus.message}
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-300 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                  >
