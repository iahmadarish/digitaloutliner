export const services = [
  {
    ...
    shortDetails:
      "Custom, responsive, and scalable websites built using modern technologies to meet your business goals.",
    fullDetails: [
  ...
  },
  {
    ...
    shortDetails:
      "Cross-platform and native mobile apps built to provide seamless digital experiences.",
    fullDetails: [
  ...
  },
  {
    ...
    shortDetails:
      "Creative visual content for branding, marketing, and product representation.",
    fullDetails: [
  ...
  },
  {
    ...
    shortDetails:
      "Professional 2D/3D designs and modeling for animation, product mockups, and architecture.",
    fullDetails: [
