  ...
  const ServiceCard = ({ service, index }: { service: any; index: number }) => {
    ...
    const getCardStyle = (index: number) => {
      const patterns = [
        ...
        { bg: "bg-green-400", text: "text-black", button: "bg-gray-800 text-white" },
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 flex flex-col sm:flex-row justify-between items-center gap-6 h-full">
          <div className="">


            {/* Service Title */}
            <div className="mb-4">
              <h3 className="text-xl font-bold leading-tight">{service.serviceType}</h3>
            </div>
          ...
          <div className="flex-shrink-0 w-32 h-32 flex items-center justify-center rounded-full bg-white/10 backdrop-blur-md shadow-inner">
            <div
