import { Search, Lock, Shield, ArrowRight, User, FileText } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-tr from-[#000] via-[#1d0303] to-[#000000] text-white min-h-screen p-8">
      <div className=" mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
        {/* Header */}
        <div className="mb-12">
          <p className="text-gray-400 text-sm mb-4">The Advantages Of Working With Us</p>
          <h1 className="text-5xl font-bold mb-6">Our Benefits</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border  shadow-sky-400 hover:shadow-xl border-gray-800">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm">JIRA-50611</span>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm">JIRA-50267</span>
                  </div>
                  <div className="flex items-center space-x-4">
          ...
          {/* Top-Tier Security */}
          <div className="bg-gray-900 rounded-xl  shadow-sky-400 hover:shadow-xl p-6 border border-gray-800">
          ...
          {/* Exponential Growth */}
          <div className="bg-gray-900 rounded-xl p-6 border hover:shadow-xl shadow-blue-600 border-gray-800">
              ...
              <div className="relative">
                <div className="w-32 h-32 border-4 border-blue-500 rounded-full flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-gray-400">Net worth growth</div>
                  </div>
                </div>
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 lg:col-span-2 hover:shadow-xl shadow-blue-600 ">
            ...
            <div className="bg-gray-800 rounded-lg p-4">
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="ml-auto text-xs text-gray-400">15m</div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-sm font-medium text-gray-400">Henry Hek</div>
                  </div>
                  <div className="ml-auto text-xs text-gray-400">25m</div>
                </div>
              </div>
            </div>
          </div>
