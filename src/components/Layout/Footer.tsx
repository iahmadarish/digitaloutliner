      ...
      <div className="mx-auto container py-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="mb-2 sm:mb-0">
            ...
            <div 
              className="sm:hidden flex justify-between items-center border-b border-gray-700 pb-2 cursor-pointer"
              onClick={() => toggleSection('company')}
            >
              <h3 className="text-[#ffffff] text-lg font-semibold">Company</h3>
              <svg 
            ...
            {/* Desktop header */}
            <h3 className="hidden sm:block text-[#ffffff] text-lg font-semibold mb-4">Company</h3>
            
            {/* Mobile dropdown content */}
            <div className={`sm:hidden overflow-hidden transition-all duration-300 ease-in-out ${openSection === 'company' ? 'max-h-96' : 'max-h-0'}`}>
          ...
          <div className="mb-2 sm:mb-0">
            ...
            >
              <h3 className="text-[#ffffff] text-lg font-semibold">Contact</h3>
              <svg 
            ...
            {/* Desktop header */}
            <h3 className="hidden sm:block text-orange-400 text-lg font-semibold mb-4">Contact</h3>
            
            {/* Mobile dropdown content */}
            <div className={`sm:hidden overflow-hidden transition-all duration-300 ease-in-out ${openSection === 'contact' ? 'max-h-96' : 'max-h-0'}`}>
              <div className="space-y-3 text-gray-300 pb-3">
                <p className="text-sm">We are working online only</p>
                <p className="text-sm">We don't have office now</p>
                <p className="text-sm break-all">weareconqueric@gmail.com</p>
            ...
            {/* Desktop content */}
            <div className="hidden sm:block space-y-3 text-gray-300">
          ...
          <div className="mb-6 sm:mb-0">
            ...
            >
              <h3 className="text-[#ffffff] text-lg font-semibold">Opening</h3>
              <svg 
                className={`w-5 h-5 transform transition-transform ${openSection === 'opening' ? 'rotate-180' : ''}`} 
                fill="none" 
                stroke="currentColor" 
                viewBox="0 0 24 24"
              >
            ...
            {/* Desktop header */}
            <h3 className="hidden sm:block text-orange-400 text-lg font-semibold mb-4">Opening</h3>
            
            {/* Mobile dropdown content */}
            <div className={`sm:hidden overflow-hidden transition-all duration-300 ease-in-out ${openSection === 'opening' ? 'max-h-96' : 'max-h-0'}`}>
              <div className="space-y-2 text-gray-300 pb-3">
                <div>
                  <p className="font-medium text-sm">Saturday-Thursday</p>
                  <p className="text-sm">24/7</p>
                </div>
                <div className="mt-3">
                  <p className="font-medium text-sm">Friday</p>
                  <p className="text-sm">8PM - 11PM</p>
                </div>
              </div>
            </div>
            
            {/* Desktop content */}
            <div className="hidden sm:block space-y-2 text-gray-300">
              <div>
          ...
          {/* Newsletter Section - No dropdown for this section */}
          <div className="mb-6 sm:mb-0">
            <h3 className="text-[#ffffff] text-center text-lg font-semibold mb-4">Newsletter</h3>
            <p className="text-gray-300 mb-4  text-justify text-sm sm:text-base">
              Submit email to get updated our all excellence news and offer! We are excited to announce that, due to our remarkable service and customer satisfaction.
            </p>
